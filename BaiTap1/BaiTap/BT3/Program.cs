...
namespace PersonListManagementSystem
{
    public class Person
    {
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("\nChọn một tùy chọn:");
                Console.WriteLine("1. Thêm đối tượng mới");
                Console.WriteLine("2. Hiển thị danh sách đối tượng");
        ...
        static void AddNewPerson()
        {
            ...
            people.Add(person);
            Console.WriteLine("Đã thêm đối tượng mới vào danh sách.");
        }
